...
-- TODO: https://github.com/glepnir/lspsaga.nvim/blob/main/README.md#customize-appearance
...
-- References
-- keymap("n", "<leader>gr", "<cmd>Lspsaga finder<CR>")
-- keymap("n", "<leader>gr", "<cmd>lua telescope.builtin.lsp_references()<CR>")
-- hover
